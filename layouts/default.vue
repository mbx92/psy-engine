<template>
  <div class="min-h-screen flex flex-col bg-background" :class="{ 'originals-workspace lg:pl-60': theme === 'originals' }">
    ...
    <main id="main-content" tabindex="-1" class="min-w-0 flex-1 outline-none" :class="theme === 'originals' ? 'originals-main w-full px-3 py-4 sm:px-4 sm:py-6 lg:px-6 lg:py-10' : 'p-4 md:p-6 lg:p-8'">
      <slot />
    </main>
  </div>
</template>
